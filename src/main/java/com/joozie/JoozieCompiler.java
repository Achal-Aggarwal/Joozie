...
import com.joozie.core.action.FsAction;
import com.joozie.core.action.HiveAction;
import com.joozie.core.action.JavaAction;
...
public class JoozieCompiler {
  ...
  */
  ...
  public static void main(String[] args) {
    System.out.println(sampleDecisionInWorkflow().build());

    System.out.println(sampleForkInWorkflow().build());

    System.out.println(sampleFsActionInWorkflow().build());

    System.out.println(sampleJavaActionInWorkflow().build());

    System.out.println(sampleHiveActionInWorkflow().build());
  }
}
